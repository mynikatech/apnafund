DROP FUNCTION IF EXISTS create_loan_approval(INT, INT, INT);
DROP FUNCTION IF EXISTS approve_loan_request(INT, INT);
DROP FUNCTION IF EXISTS reject_loan_request(INT, INT, TEXT);
