ALTER TABLE loans ADD COLUMN IF NOT EXISTS "closedDate" TEXT NULL;
ALTER TABLE loans ADD COLUMN IF NOT EXISTS "closureType" TEXT NULL;
ALTER TABLE loans ADD COLUMN IF NOT EXISTS "closureSource" TEXT NULL;
...
CREATE TABLE IF NOT EXISTS loan_closure_requests (
    "approvalId" INTEGER PRIMARY KEY
        REFERENCES approval_requests("approvalId")
        ON DELETE CASCADE,
    ...
    closure_type TEXT NOT NULL
        CHECK (closure_type IN ('FORECLOSURE', 'MATURITY')),
...
LANGUAGE sql STABLE AS $$
  SELECT
    ...
    l."rateOfInterest", l."status", l."closedDate", l."closureType", l."closureSource",
